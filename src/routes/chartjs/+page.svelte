<script>
    ...
    onMount(() => {
        ...
        const radarChart = document
            ...
            .getContext("2d");
        const bubbleChart = document
            .getElementById("bubbleChart")
            .getContext("2d");
        const multipleLineChart = document
            .getElementById("multipleLineChart")
            .getContext("2d");
        const multipleBarChart = document
            .getElementById("multipleBarChart")
            .getContext("2d");
        const htmlLegendsChart = document
        ...
        // Bubble Chart
        myBubbleChart = new Chart(bubbleChart, {
            type: "bubble",
            data: {
                datasets: [
                    {
                ...
                datasets: [
                    {
                        ...
                        borderWidth: 2,
                        data: [
                            30, 45, 45, 68, 69, 90, 100, 158, 177, 200, 245,
                            256,
                        ],
                    },
                    {
                    ...
                    },
                    {
                        ...
                        borderWidth: 2,
                        data: [
                            10, 30, 58, 79, 90, 105, 117, 160, 185, 210, 185,
                            194,
                        ],
                    },
                ],
                ...
                datasets: [
                    {
                        ...
                        borderColor: "#59d05d",
                        data: [
                            95, 100, 112, 101, 144, 159, 178, 156, 188, 190,
                            210, 245,
                        ],
                    },
                    {
                        ...
                        borderColor: "#fdaf4b",
                        data: [
                            145, 256, 244, 233, 210, 279, 287, 253, 287, 299,
                            312, 356,
                        ],
                    },
                    {
                        ...
                        borderColor: "#177dff",
                        data: [
                            185, 279, 273, 287, 234, 312, 322, 286, 301, 320,
                            346, 399,
                        ],
                    },
                ],
        ...
        const gradientStroke = htmlLegendsChart.createLinearGradient(
            500,
            0,
            100,
            0,
        ...
        const gradientFill = htmlLegendsChart.createLinearGradient(
            500,
            0,
            100,
            0,
        ...
        const gradientStroke2 = htmlLegendsChart.createLinearGradient(
            500,
            0,
            100,
            0,
        ...
        const gradientFill2 = htmlLegendsChart.createLinearGradient(
            500,
            0,
            100,
            0,
        ...
        const gradientStroke3 = htmlLegendsChart.createLinearGradient(
            500,
            0,
            100,
            0,
        ...
        const gradientFill3 = htmlLegendsChart.createLinearGradient(
            500,
            0,
            100,
            0,
                ...
                scales: {
                    y: {
                        ticks: {
                            ...
                            font: {
                                weight: "bold", // Changed from style: "500"
                            },
                            beginAtZero: false,
                            maxTicksLimit: 5,
                            padding: 20,
        ...
        if (myLegendContainer) {
            ...
            for (let i = 0; i < legendItems.length; i++) {
                legendItems[i].addEventListener(
                    "click",
                    (event) =>
                        legendClickCallback(event, myHtmlLegendsChart, i),
                    false,
                );
            }
        }
...
<div class="page-category">
    Simple yet flexible JavaScript charting for designers & developers. Please
    checkout their
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <div class="chart-container">
                    <canvas id="pieChart" style="width: 50%; height: 50%"
                    ></canvas>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <div class="chart-container">
                    <canvas id="doughnutChart" style="width: 50%; height: 50%"
                    ></canvas>
                </div>
            </div>
        </div>
